...
function update_balance() {
  ...
  $('.rtot').html(rtot);
  $('#round_hid').val(due);
  $('#inwords').html("Rs.200" + words + "Only");
  $('#towords').val("Rs.200" + words + "Only");
}
