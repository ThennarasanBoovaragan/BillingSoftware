                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                      <ul class="nav nav-tabs sales-mini-tabs ml-lg-auto mb-4 mb-md-0" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link " id="sales-statistics_switch_1" data-toggle="tab" role="tab" aria-selected="true">1D</a>
                        </li>
                        <li class="nav-item">
...
(function ($) {
  ...
  $(function () {
    ...
    if ($('#sales-statistics-overview').length) {
      ...
      var data_1_2 = [10, 25, 20, 40, 70, 52, 49, 90, 70, 94, 110, 135];
        
      var data_5_1 = <?php echo json_encode($rbdf); ?>;
      var data_5_2 = <?php echo json_encode($rbdf); ?>;
        
      var data_2_1 = [130, 145, 155, 60, 75, 65, 130, 110, 145, 149, 170];
      var data_2_2 = [10, 70, 52, 90, 25, 20, 40, 70, 49, 94, 110, 135];

      var data_3_1 = [130, 75, 65, 130, 110, 145, 155, 60, 145, 149, 170];
      var data_3_2 = [10, 70, 52, 94, 110, 135, 90, 25, 20, 40, 70, 49];

      var data_4_1 = [130, 145, 65, 130, 75, 145, 149, 170, 110, 155, 60];
      var data_4_2 = [10, 70, 90, 25, 40, 20, 94, 110, 135, 70, 49, 52];
      var areaData = {
